---
title: Disabled Parking Placards
description: Who qualifies for a disabled parking placard or plate, how to apply, and how the rules differ by state and country.
published: true
...
## What a Placard Is Actually For
...
If your condition fluctuates, the criteria are about your capacity when limited, not on your best day. See [invisible disabilities](/conditions/invisible-disabilities) and [invisible, fluctuating and episodic disability](/conditions/invisible-fluctuating-episodic).
...
1. Get the application form from your state's motor vehicle agency. The [USA.gov directory of state motor vehicle services](https://www.usa.gov/motor-vehicle-services) links each state's agency.
...
### Permanent, Temporary, and Plates
...
**Being told you do not look disabled enough.** This happens both from clinicians filling in forms and from strangers in parking lots. The criteria are written in terms of function, not appearance. You are not obliged to explain yourself to bystanders, and [handling intrusive questions](/foundations/handling-intrusive-questions) has scripts if you want them.
...
**Not enough accessible spaces, or spaces blocked.** A placard does not create a space. Design standards, enforcement, and complaint routes are state and local matters under 23 CFR 1235.7. Access to the built environment more generally is covered by the [ADA](/rights/us/ada) in the US.
