...
### ⏳ OPEN
- [x] discord.md structural fix — rewritten as a genuine Discord page 2026-06-10 (accessibility features verified against discord.com/accessibility + support docs; no named servers listed — churn risk — discovery directories instead). es/community/online-communities/discord.md had the same defect (Spanish Reddit content under a Discord title) — DONE 2026-06-10: replaced with a fresh translation of the rewritten English page, and es/community/online-communities/index.md synced with the Actividad bullet + scam/predation note; both pass check_translation.py (see docs/translation-source-accuracy-flags.md).
...
- [x] **es/ sync — life-safety**: DONE 2026-06-10 — all 18 es/ counterparts of the files in commits 78b2ed3 + 7328e33 synced (crisis pages, mental-health, disability-culture T4, eugenics, global-timelines, housing-rights/home-modifications, healthcare-providers, public-safety-officers, screen-reader-comparison); all pass check_translation.py. See docs/translation-source-accuracy-flags.md for details + 2 new EN flags (nigeria.md:123 "Lifeline works nationwide" leftover; thailand.md leaf still has obsolete Samaritans 02-713-679x as 24/7)
