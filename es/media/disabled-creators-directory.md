...
<!-- The creator tables on this page are GENERATED from data/creators.yaml (shared with the English page). Edit that file, then run: python3 scripts/creators_directory.py. Hand edits between the creators: markers fail CI. -->
...
| Eli Clare | Discapacidad física | Teoría/memoria | Brilliant Imperfection |
...
| Judy Heumann (1947-2023) | Polio, usuaria de silla de ruedas | Memoria/activismo | Being Heumann |
...
|------|------------|----------|---------|
| Alice Wong | AME, usuaria de silla de ruedas | Disability Visibility Podcast | Cultura de la discapacidad |
...
|------|------------|---------------|
| Alice Wong | AME, usuaria de silla de ruedas | Escritura, pódcast, edición |
| Haben Girma | Sordociega | Escritura, conferencias |
| Imani Barbarin | Parálisis cerebral | Escritura, redes sociales |
| Judy Heumann (1947-2023) | Polio, usuaria de silla de ruedas | Memoria, conferencias |
| Leah Lakshmi Piepzna-Samarasinha | Enfermedad crónica, neurodivergente | Escritura, performance |
