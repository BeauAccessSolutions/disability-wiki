...
### Qué cuenta como educación de adultos y educación continua

**Programas formales:** community colleges, universidades, programas de certificación profesional, escuelas de oficios
...
**Accesibilidad** significa que la educación está diseñada desde el inicio para incluir a las personas con discapacidad. Esto incluye el acceso físico, el acceso a la comunicación, la accesibilidad cognitiva y la flexibilidad.
...
Para muchas personas adultas con discapacidad, la educación continua es la forma en que logramos la independencia económica, cambiamos de carrera, nos mantenemos actualizados en nuestros campos o buscamos lo que de verdad nos interesa. El acceso educativo también significa:
...
Los **community colleges y las universidades** a menudo tienen oficinas sólidas de apoyo a la discapacidad. Antes de inscribirte:
...
- Las **organizaciones de justicia para las personas con discapacidad** a menudo ofrecen talleres e intercambios de habilidades
...
Muchas personas adultas con discapacidad aprenden mediante:
...
Los oficios especializados (carpintería, plomería, trabajo eléctrico) pueden ser caminos accesibles hacia el empleo. Algunas consideraciones:
...
### Para personas adultas ciegas y con baja visión

- Asegúrate de que los materiales del curso estén en formatos accesibles (no solo PDF de documentos escaneados)
...
- CART (subtitulado en tiempo real), personas intérpretes de ASL o subtítulos
...
- Accesibilidad física de edificios y aulas
...
- Asistencia flexible (opciones asincrónicas, clases grabadas)
...
- Información clara y estructurada (lenguaje sencillo, programa de estudios organizado)
...
- Enseñanza sensible al trauma (avisos sobre el contenido, opciones de no participar)
...
- Planificación centrada en la persona (¿qué quiere aprender esta persona?)
...
- Planificación de acceso interseccional (no solo adaptaciones de "discapacidad", sino comprender cómo la raza, la clase, el idioma, el estatus migratorio, la identidad de género, etc., moldean el acceso)
...
**Paso 1:** Contacta a los servicios para la discapacidad temprano (antes de que empiecen las clases, si es posible)
...
En muchos lugares, puedes solicitar adaptaciones sin un diagnóstico formal. Puedes:
...
"Tengo una discapacidad que afecta [área: lectura, concentración, memoria, capacidad de estar en aulas]. Necesito [adaptación específica]. Esto me ayudará a [resultado específico]."
...
- **Community colleges:** a menudo más baratos que las universidades; muchos ofrecen ayuda financiera para estudiantes con discapacidad
...
- **Pell Grants (EE. UU.):** ayuda federal para estudiantes de bajos ingresos, incluidas las personas con discapacidad
...
- **Norte Global:** por lo general hay más financiamiento institucional disponible; navega la burocracia con cuidado
...
**La suposición de que las personas adultas con discapacidad no deberían trabajar ni aprender**
...
- Contratar a personas con discapacidad como docentes, asesoras y personal
...
### Aprendizaje liderado por la discapacidad en el Sur Global

En países sin sistemas formales sólidos de educación de adultos, las personas con discapacidad a menudo aprenden mediante:
...
- **Becas transversales a la discapacidad:** algunas organizaciones internacionales apoyan a estudiantes con discapacidad del Sur Global
...
Muchas comunidades indígenas tienen sus propios sistemas educativos que a menudo son más accesibles para las personas con discapacidad que los modelos occidentales:
...
### Preguntas para hacerles a los programas

- ¿Tienen servicios para la discapacidad? ¿Cuál es el proceso para solicitar adaptaciones?
...
1. **Identifica tus necesidades de acceso:** ¿qué te ayuda a aprender? (flexibilidad, subtítulos, espacio silencioso, pausas de movimiento, etc.)
2. **Explora opciones:** ¿qué programas se ajustan a tus necesidades, intereses, horario y presupuesto?
3. **Contacta a los servicios para la discapacidad temprano:** antes de inscribirte, si es posible
4. **Solicita adaptaciones específicas:** con ejemplos y fundamentos
5. **Construye comunidad:** conéctate con otras personas estudiantes con discapacidad
6. **Planifica para el éxito:** ¿qué apoyo necesitas? ¿Qué planes de respaldo tienes?
7. **Defiende tus derechos:** si no proveen las adaptaciones, conoce tus derechos y busca apoyo
...
- **Community colleges en tu zona:** busca "[tu ciudad] community college"
...
- **Free Application for Federal Student Aid (FAFSA) (EE. UU.):** www.fafsa.gov
...
- **Disability Rights Education & Defense Fund (DREDF):** información sobre derechos en la educación
...
- **Disabled and Here:** historias de personas con discapacidad que se destacan en la educación y el trabajo
...
Esta página está escrita por y para personas adultas con discapacidad. Damos la bienvenida a las contribuciones de:
