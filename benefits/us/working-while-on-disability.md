---
title: Working While on Disability (US)
description: How the Trial Work Period, SGA, and SSI earnings rules actually work, what the 2026 figures are, and how to try work without losing everything.
published: true
...
Before acting on anything below, talk to a benefits counselor. The rules interact with each other, with your specific work history, and with state Medicaid rules, in ways no general page can resolve for an individual.

The Social Security Administration funds this service, and it is free:

- **Work Incentives Planning and Assistance (WIPA)** projects provide individual benefits counseling. Find one through [Ticket to Work's help finder](https://choosework.ssa.gov/findhelp/).
...
This distinction causes more confusion than anything else in this area, and advice for one is often wrong for the other.
...
You get **nine trial work months** in which you can earn any amount at all and still receive your full benefit. They do not have to be consecutive. They are counted within a rolling sixty-month window.
...
After the nine trial months, a **thirty-six month** extended period of eligibility begins. During it, you receive your benefit for any month your earnings are not above the substantial gainful activity level, and you do not receive it for months you are above. Benefits switch off and on with your earnings rather than terminating.
...
If you are still working above the substantial gainful activity level once the extended period ends, benefits generally stop. This is the cliff people are actually afraid of, and it arrives roughly three and a half to four years after you first start earning meaningfully, not immediately.
...
Medicare coverage generally continues for a period after benefits stop because of work, and there is an option to buy in afterward. Because the duration and cost depend on your circumstances, confirm the specifics with a benefits counselor. See [Medicare](/benefits/us/medicare).

---

## If You Receive SSI

### The Arithmetic Is Gradual, Not a Cliff

SSI does not cut off at a threshold. It reduces your payment as countable income rises, and the calculation deliberately counts less than half of what you earn.
...
Verified against SSA's published amounts in August 2026. **These change annually**, so confirm current values before relying on them.
...
These rules interact with your work history, your state's Medicaid program, any private [long-term disability insurance](/benefits/long-term-disability-insurance) that offsets against your benefits, and your specific medical situation. Nothing here is individualized advice, and the free counseling above exists precisely because general information is not sufficient to plan with.

---

## Resources

- [Ticket to Work](https://choosework.ssa.gov/) — SSA's employment support program, including the [help finder](https://choosework.ssa.gov/findhelp/) for free local benefits counseling
- [SSA: Substantial Gainful Activity amounts](https://www.ssa.gov/oact/cola/sga.html) — current and historical figures
- [SSA: Trial Work Period amounts](https://www.ssa.gov/oact/cola/twp.html) — current and historical figures
- [SSA Red Book](https://www.ssa.gov/redbook/) — SSA's full reference on employment supports for SSDI and SSI
...
- [SSI](/benefits/us/ssi)
- [Medicaid](/benefits/us/medicaid) and [Medicare](/benefits/us/medicare)
...
- [ABLE Accounts](/benefits/us/able-accounts)
- [Supported Employment and Vocational Rehabilitation](/employment/supported-employment-and-voc-rehab)
